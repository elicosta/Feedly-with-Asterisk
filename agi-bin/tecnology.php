...
// set URL- Category Tecnology
curl_setopt($freedly, CURLOPT_URL, "https://cloud.feedly.com/v3/streams/contents?unreadOnly=true&streamId=user/558d1cdc-5e1a-4e3e-9a7f-66b03b7b4ac6/category/5017c6bc-9eac-4be2-aef9-062cd6c1b8c9&count=10");
// set Token
...
foreach ($titulos as $a){
    ...
    if($op == $i){
        foreach ( $link as $d ){
            ...
            $article = $xpath->query("//div[@id=\"js_expandable-container\"]");
