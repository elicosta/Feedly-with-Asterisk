...
// set URL- Category Economy
curl_setopt($freedly, CURLOPT_URL, "https://cloud.feedly.com/v3/streams/contents?unreadOnly=true&streamId=user/558d1cdc-5e1a-4e3e-9a7f-66b03b7b4ac6/category/543c8d53-c71c-40f2-b5cb-478e93d7cbc1&count=10");
...
foreach ($titulos as $a){
    ...
    if($result['result'] == $i){
        foreach ( $link as $d ){
            ...
            $article = $xpath->query("//div[@itemprop=\"articleBody\"]");
